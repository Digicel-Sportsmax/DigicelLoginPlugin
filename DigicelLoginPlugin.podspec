Pod::Spec.new do |s|
  ...
  s.homepage            = 'https://github.com/Digicel-Sportsmax/DigicelLoginPlugin'
  s.license             = 'MIT'
  s.author              = { "Mohieddine Zarif" => "mohieddine.zarif@gotocme.com" }
  s.source              = { :git => 'git@github.com:Digicel-Sportsmax/DigicelLoginPlugin.git', :tag => s.version.to_s }
